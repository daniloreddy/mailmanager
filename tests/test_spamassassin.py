...
@pytest.fixture
def client() -> SpamAssassinClient:
    return SpamAssassinClient(SpamAssassinConfig())


def test_parse_spam_header_true(client: SpamAssassinClient) -> None:
...
def test_parse_spam_header_false(client: SpamAssassinClient) -> None:
